...
(
    NAME = N'OpinionDW_Primary',
        FILENAME = 'C:\Users\PC\Desktop\Tareas ITLA\Electiva 1 - Big Data\Unidad 5\ETLWorkerService\SQLData\OpinionDW_Primary.mdf',
    SIZE = 10MB,
    MAXSIZE = UNLIMITED,
    FILEGROWTH = 5MB
),
...
(
    NAME = 'OpinionDW_2024',
        FILENAME = 'C:\Users\PC\Desktop\Tareas ITLA\Electiva 1 - Big Data\Unidad 5\ETLWorkerService\SQLData\Opinion2024\OpinionDW_2024.ndf',
    SIZE = 10MB,
    MAXSIZE = UNLIMITED,
    FILEGROWTH = 5MB
),
...
(
    NAME = 'OpinionDW_2025',
        FILENAME = 'C:\Users\PC\Desktop\Tareas ITLA\Electiva 1 - Big Data\Unidad 5\ETLWorkerService\SQLData\Opinion2025\OpinionDW_2025.ndf',
    SIZE = 10MB,
    MAXSIZE = UNLIMITED,
    FILEGROWTH = 5MB
),
...
(
    NAME = 'OpinionDW_2026',
        FILENAME = 'C:\Users\PC\Desktop\Tareas ITLA\Electiva 1 - Big Data\Unidad 5\ETLWorkerService\SQLData\Opinion2026\OpinionDW_2026.ndf',
    SIZE = 10MB,
    MAXSIZE = UNLIMITED,
    FILEGROWTH = 5MB
)
...
(
    NAME = N'OpinionDW_Log',
        FILENAME = 'C:\Users\PC\Desktop\Tareas ITLA\Electiva 1 - Big Data\Unidad 5\ETLWorkerService\SQLData\Logs\OpinionDW.ldf',
    SIZE = 10MB,
    MAXSIZE = 2GB,
    FILEGROWTH = 5MB
);
...
CREATE TABLE FactOpiniones (
    ...
    CONSTRAINT PK_FactOpiniones PRIMARY KEY (OpinionKey),
